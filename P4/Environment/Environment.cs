...
namespace BuildEnvironment
{
    ...
    public struct ClientEnvironment
    {
        ...
        public const long blockSize = 1024;
        public static string endPoint { get; set; } = "http://localhost:5261/IPluggableComm";
        public static string address { get; set; } = "http://localhost";
        public static int port { get; set; } = 5261;
    ...
    public struct ServerEnvironment
    {
        ...
        public const long blockSize = 1024;
        public static string endPoint { get; set; } = "http://localhost:5260/IPluggableComm";
        public static string address { get; set; } = "http://localhost";
        public static int port { get; set; } = 5260;
        public static bool verbose { get; set; } = false;
    }
}
