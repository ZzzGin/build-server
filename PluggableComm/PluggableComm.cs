 ...
 * --------------------
 * ver 1.1: 20 Oct 2017
 * - Do some changes to suit for my project
 * 
 * --------------------
 * ver 1.0 : 14 Jun 2017
 * - first release
...
namespace PluggableComm
{
    ...
    public class Receiver : IPluggableComm
    {
        ...
        public bool openFileForWrite(string dir, string name)
        {
            try
            {
    ...
    public class Comm
    {
        ...
        public bool postFile(string fromDir, string toDir, string filename)
        {
            return sndr.postFile(fromDir, toDir, filename);
        }
    }
    ///////////////////////////////////////////////////////////////////
    ...
    class TestPCommService
    {
        ...
        public static List<string> getClientFileList()
        {
            ...
            string[] files = Directory.GetFiles(ServiceClientEnvironment.fileStorage);
        ...
        public static bool testSndrRcvr()
        {
            ...
            if (BuildEnvironment.ClientEnvironment.verbose)
                rcvMsg.show();
        ...
        {
            BuildEnvironment.ClientEnvironment.verbose = true;
